...
class ProductListFromCategory extends React.Component {
  ...
  componentDidMount() {
    ...
    const subCategories = this.props.navigation.state.params
      ...
      ? this.props.navigation.state.params.selectedSubCategories
      : [];
    ...
    this.props.getSubCategoryList(
      ...
      (subCategories) => {
        this.setState({ subCategoryArray: subCategories });
      }
    );
  ...
  _updateHeaderViewData = (filterArray) => {
    ...
    this.setState({ isGenderAvailable, isSubCategoryAvailable, ageGroupArray });
  };
  ...
  _getProductListData = (selectedSubCategoryId, isFromFilterApply) => {
    const { pageIndexCategory1, isFromHome } = this.state;
    ...
    this.props.getCategoryProductsList(
      ...
      filterParams,
      (status, isLoadMore) => {
        this._getCategoryProductsListCallback(status, 1, isLoadMore);
      },
      isFromHome
    );
  };
  ...
  _didChangeGenderCategory = (selectedGenderIndexVal) => {
    ...
    switch (selectedGenderIndexVal) {
      case 0:
        ...
        break;
      case 1:
        filterParams["gender"] = [5508, 5510]; // Boys
        filterParams["age_range"] = [];
        break;
      case 2:
        filterParams["gender"] = [5509, 5510]; // Girls
        filterParams["age_range"] = [];
        break;
      case 3:
        filterParams["gender"] = []; // All
        filterParams["age_range"] = [5680]; // infant
        break;
    }
    ...
    switch (genderType) {
      case "all":
        ...
        if (
          ...
          genderImage_3_6 = Images.uniSex_infant;
        } else if (
          item.value == 5686 ||
          item.value == 5682 ||
          // item.value == 5683 ||
          ...
          genderImage_3_6 = Images.uniSex_3_6;
        } else if (
          item.value == 5695 ||
          item.value == 5688 ||
          item.value == 5693 ||
          ...
          genderImage_3_6 = Images.uniSex_7_10;
        } else if (item.value == 5684) {
          genderImage_3_6 = Images.uniSex_11_13;
        } else {
          genderImage_3_6 = Images.uniSex_13_plus;
        }
      ...
      case "boys":
        ...
        if (
          ...
          genderImage_3_6 = Images.boy_infant;
        } else if (
          item.value == 5686 ||
          item.value == 5682 ||
          // item.value == 5683 ||
          ...
          genderImage_3_6 = Images.boy_7_10;
        } else if (item.value == 5684) {
          genderImage_3_6 = Images.boy_11_13;
        } else {
          genderImage_3_6 = Images.boy_13_plus;
        }
        break;
      case "girls":
        ...
        if (
          ...
          genderImage_3_6 = Images.girl_infant;
        } else if (
          item.value == 5686 ||
          item.value == 5682 ||
          // item.value == 5683 ||
          ...
          genderImage_3_6 = Images.girl_7_10;
        } else if (item.value == 5684) {
          genderImage_3_6 = Images.girl_11_13;
        } else {
          genderImage_3_6 = Images.girl_13_plus;
        }
        break;
    }
  ...
  _didChangeSubCategory = (selectedSubCatIndexVal) => {
    const {
      selectedSubCatIndex,
      selectedSubCategoryId,
      subCategoryArray,
    } = this.state;
    if (selectedSubCatIndexVal === selectedSubCatIndex) return;
    this.setState({ selectedSubCatIndex: selectedSubCatIndexVal });

    let filter = this.state.filterParams;
    let filterParams = filter.filter_attributes ? filter.filter_attributes : {};

    if (selectedSubCatIndexVal == 0) {
      filterParams["cat"] = [];
    } else {
      let selectedSubCat = subCategoryArray[selectedSubCatIndexVal - 1];
      filterParams["cat"] = [selectedSubCat.id];
    }
  ...
  _renderSubCategories = ({ item, index }, genderType, totalItemsCount) => {
    const { selectedSubCatIndex } = this.state;
          ...
          styles.subCatContainer,
          {
            backgroundColor:
              selectedSubCatIndex == index
                ? activeSelectedColor
                : Constants.APP_WHITE_COLOR,
            borderWidth: selectedSubCatIndex == index ? 0 : 1,
            marginRight: totalItemsCount - 1 == index ? 20 : 0,
          },
        ]}
        onPress={() => this._didChangeSubCategory(index)}
      >
        {index == 0 && (
          <Text
            style={[
            ...
            <View style={styles.subCatImageContainer}>
              <ImageLoader
                ...
                renderError={(e) => {
                  return (
                    <Image
                      source={Images.cat_def_small}
                      style={{ width: 32, height: 32 }}
                    />
                  );
                }}
                style={{ width: 32, height: 32 }}
                defaultSource={Images.cat_def_small}
      ...
      <SafeAreaView style={styles.safeContainer}>
        ...
        {isGenderAvailable && (
          <View style={styles.superTitleContainer}>
            ...
            <TouchableOpacity
              hitSlop={{ left: 10, top: 10, bottom: 10, right: 10 }}
              onPress={() => this._didChangeGenderCategory(3)}
            >
              <Text style={styles.topTitle}>
                {translate("INFANT").toUpperCase()}
              </Text>
              <View
                style={[
                  styles.genderCategoryUnderLine,
                  {
                    height: selectedGenderIndex == 3 ? 2 : 0,
                    backgroundColor: Constants.APP_THEME_COLOR,
                  },
                ]}
              />
